...
import { CalendarDays, Car, ExternalLink, FileImage, FileText, Info, MapPin, User, Tag, Truck, Gauge, Maximize } from 'lucide-react';
    ...
    <div className="pt-2">
      ...
      <Tabs defaultValue="general">
        <TabsList className="w-full bg-secondary/50 p-1">
          ...
          {((vehicle.attachments && vehicle.attachments.length > 0) || (vehicle.images && vehicle.images.length > 0)) && (
